...
export const processRemoteResources = (resource: string, baseURL: string, commonHeaders: any = {}): IResource => {
  ...
  return {
    create: (payload: any, headers: any = {}) => axios.post(`/${resource}`, payload, {
      ...config,
      headers: { ...commonHeaders, ...headers }
    }),
    destroy: (id: string | number, headers: any = {}) => axios.delete(`/${resource}/${id}`, {
      ...config,
      headers: { ...commonHeaders, ...headers }
    }),
    getOne: (id: string | number, headers: any = {}) => axios.get(`/${resource}/${id}`, {
      ...config,
      headers: { ...commonHeaders, ...headers }
    }),
    ...
    update: (id: string | number, payload: any, headers: any = {}) => axios.put(`/${resource}/${id}`, payload, {
      ...config,
      headers: { ...commonHeaders, ...headers }
    }),
  };
